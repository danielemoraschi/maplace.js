...
this.o.listeners.hasOwnProperty(c)&&d.maps.event.addListener(this.oMap,c,function(){h(k)})}}this.loaded=!0};return c}();"function"==typeof define&&define.amd?define(function(){return p}):s.Maplace=p})(jQuery,this,google);