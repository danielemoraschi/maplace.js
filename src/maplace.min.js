...
this.controls_wrapper.append(this.get_html_controls())};d.prototype.init_map=function(){var a=this,b=0;this.Polyline&&this.Polyline.setMap(null);this.Polygon&&this.Polygon.setMap(null);this.Fusion&&this.Fusion.setMap(null);this.directionsDisplay&&this.directionsDisplay.setMap(null);if(this.markers){for(b in this.markers)if(this.markers[b])try{this.markers[b].setMap(null)}catch(c){a.errors.push(c)}this.markers.length=0;this.markers=[]}this.o.controls_on_map&&this.oMap.controls&&this.oMap.controls[this.o.controls_position].forEach(function(b,
c){a.oMap.controls[this.o.controls_position].removeAt(c)});this.oBounds=new e.maps.LatLngBounds;this.debug("02")};d.prototype.perform_load=function(){1==this.ln?this.ViewOnMap(1):0===this.ln?(this.o.map_options.set_center?this.oMap.setCenter(new e.maps.LatLng(this.o.map_options.set_center[0],this.o.map_options.set_center[1])):this.oMap.fitBounds(this.oBounds),this.oMap.setZoom(this.o.map_options.zoom)):(this.oMap.fitBounds(this.oBounds),"number"==typeof(this.o.start-0)&&0<this.o.start&&this.o.start<=
